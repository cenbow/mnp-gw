 ...
 *         &lt;element name="NumberWithPinWithCLHFlag" type="{}NumTypeWithPinWithCLHFlag" maxOccurs="6000"/>
...
public class PortReqAckMsgType {
    ...
    @XmlElement(name = "NumberWithPinWithCLHFlag", required = true)
    protected List<NumTypeWithPinWithCLHFlag> numberWithPinWithCLHFlag;
    ...
    /**
     * Gets the value of the numberWithPinWithCLHFlag property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the numberWithPinWithCLHFlag property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    getNumberWithPinWithCLHFlag().add(newItem);
 </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NumTypeWithPinWithCLHFlag }
     * 
     * 
     */
    public List<NumTypeWithPinWithCLHFlag> getNumberWithPinWithCLHFlag() {
        if (numberWithPinWithCLHFlag == null) {
            numberWithPinWithCLHFlag = new ArrayList<NumTypeWithPinWithCLHFlag>();
        }
        return this.numberWithPinWithCLHFlag;
    }
