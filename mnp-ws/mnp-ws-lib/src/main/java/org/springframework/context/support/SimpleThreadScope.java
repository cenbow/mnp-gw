...
public class SimpleThreadScope implements Scope {
	...
	public void registerDestructionCallback(String name, Runnable callback) {
		//FIXME: Suppress msg level  in logback instaed
		//logger.warn("SimpleThreadScope does not support destruction callbacks. " +	"Consider using RequestScope in a web environment.");
		logger.info("SimpleThreadScope does not support destruction callbacks. " +	"Consider using RequestScope in a web environment.");
