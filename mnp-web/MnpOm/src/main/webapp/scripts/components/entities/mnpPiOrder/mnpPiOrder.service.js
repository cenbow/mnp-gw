...
angular.module('mnpOmApp')
    .factory('MnpPiOrder', function ($resource, DateUtils) {
        return $resource('api/mnpPiOrders/:id', {}, {
            ...
            'get': {
                ...
                transformResponse: function (data) {
                    ...
                    data.submittedDate = DateUtils.convertLocaleDateFromServer(data.submittedDate);
            ...
            'update': {
                ...
                transformRequest: function (data) {
                    ...
                    data.submittedDate = DateUtils.convertLocaleDateToServer(data.submittedDate);
