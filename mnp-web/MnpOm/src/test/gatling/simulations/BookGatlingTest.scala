...
class BookGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Book entity")
        ...
        .repeat(2) {
            ...
            .post("/api/books")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "publicationDate":"2020-01-01T00:00:00.000Z", "price":null, "publisherName":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
