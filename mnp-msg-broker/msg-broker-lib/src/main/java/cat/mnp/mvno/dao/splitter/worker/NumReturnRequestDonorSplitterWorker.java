 ...
 * @author HP-CAT
 */
public class NumReturnRequestDonorSplitterWorker extends Worker {
    ...
    public void execute(Connection connection) throws SQLException {
        ...
        NumReturnFwdMsgType msg = (NumReturnFwdMsgType) msgObject;
        ...
        try (CallableStatement callableStatement = connection.prepareCall(plSqlQuery)) {
            ...
            for (String mvnoName : mvnoNameMultimap.keySet()) {//build parent
                NumReturnFwdMsgType parent = new NumReturnFwdMsgType();
