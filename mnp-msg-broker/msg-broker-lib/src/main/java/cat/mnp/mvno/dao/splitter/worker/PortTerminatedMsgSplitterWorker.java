 ...
 * @author HP-CAT
 */
public class PortTerminatedMsgSplitterWorker extends Worker {
    ...
    public void execute(Connection connection) throws SQLException {
        ...
        PortTerminatedMsgType msg = (PortTerminatedMsgType) msgObject;
        ...
        try (CallableStatement callableStatement = connection.prepareCall(plSqlQuery)) {
            ...
            for (String mvnoName : mvnoNameMultimap.keySet()) {//build parent
                PortTerminatedMsgType parent = new PortTerminatedMsgType();
