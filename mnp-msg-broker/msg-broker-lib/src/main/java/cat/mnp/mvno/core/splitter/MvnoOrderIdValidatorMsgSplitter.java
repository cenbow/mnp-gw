 ...
 * @author HP-CAT
 */
public class MvnoOrderIdValidatorMsgSplitter extends MsgHandlerBase {

    private static final Logger logger = LoggerFactory.getLogger(MvnoOrderIdValidatorMsgSplitter.class);
    ...
    public void processMsg(String msgString) throws Exception {
        ...
        if (msgList.size() > 0) {
            ...
            logger.info("Blocking MvnoOrderIdMsg size: {} orders, msgId: {}", msgList.size(), msgId);
