...
@XmlRootElement(name = "cancelPinCodeRequest")
public class CancelPinCodeRequest {
    ...
    public String toString() {
        return "CancelPinCodeRequest{" + "channelType=" + channelType + ", channelRefNumber=" + channelRefNumber + ", cardNumber=" + cardNumber + ", msisdnList=" + msisdnList + ", contactChannelType=" + contactChannelType + ", contactEmailAddress=" + contactEmailAddress + ", contactMsisdn=" + contactMsisdn + '}';
    }
