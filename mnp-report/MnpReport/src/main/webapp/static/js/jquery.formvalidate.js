...
(function($) {
    ...
    $.fn.formvalidate.options = {
        ...
        _process: function(form, options) {
            ...
            if ( ! ('validations' in inputs[attrName]) )  {
                inputs[attrName].validations = {};            
            }

            // Filters object for this input
            if ( ! ('filters' in inputs[attrName]) )  {
                inputs[attrName].filters = {};            
        }
...
_displayMessages: function(form, inputs) {
    ...
    if ( form.options.failureMessages === false && form.options.successMessages === false ) {
        return false;
    }
