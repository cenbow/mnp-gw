...
/**
 * @odo document me Utilites class to convert report paramete value between
 * object and string.
 */
public class ReportParameterConverter {
    ...
    /**
     * @param format format to format report parameter, or recover parameter
     * value as object given a string as report parameter value
