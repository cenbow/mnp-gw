...
/**
 * <p>Java class for PortReqDonorType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PortReqDonorType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="NumberDataBasePayRef" type="{}NumTypeBaseWithPaymentRef" maxOccurs="unbounded"/>
...
@XmlType(name = "PortReqDonorType", propOrder = {
    "processType",
    "orderId",
    "orderDate",
    "validationDeadline",
    ...
    "recipient",
    "operatorCode",
    "numberDataBasePayRef",
    "subscriberData"
})
public class PortReqDonorType {
    ...
    @XmlElement(name = "NumberDataBasePayRef", required = true)
    protected List<NumTypeBaseWithPaymentRef> numberDataBasePayRef;
    ...
    /**
     * Gets the value of the numberDataBasePayRef property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the numberDataBasePayRef property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNumberDataBasePayRef().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NumTypeBaseWithPaymentRef }
     * 
     * 
     */
    public List<NumTypeBaseWithPaymentRef> getNumberDataBasePayRef() {
        if (numberDataBasePayRef == null) {
            numberDataBasePayRef = new ArrayList<NumTypeBaseWithPaymentRef>();
        }
        return this.numberDataBasePayRef;
    }

    public void setNumberDataBasePayRef(List<NumTypeBaseWithPaymentRef> numberDataBasePayRef) {
        this.numberDataBasePayRef = numberDataBasePayRef;
    }
